...
def processFile(path, filename):
    ...
    for name, values in enums:
        ...
        output.write('RENDU_API_EXPORT EnumText EnumUtils<%s>::ToString(%s value)\n' % (name, name))
        output.write('{\n')
        ...
        output.write('\n')
        output.write('template <>\n');
        output.write('RENDU_API_EXPORT size_t EnumUtils<%s>::Count() { return %d; }\n' % (name, len(values)))
        output.write('\n')
        output.write('template <>\n');
        output.write('RENDU_API_EXPORT %s EnumUtils<%s>::FromIndex(size_t index)\n' % (name, name))
        output.write('{\n')
