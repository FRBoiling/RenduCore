...
class EnumUtils
{
    public:
        template <typename Enum>
        static size_t Count() { return Rendu::Impl::EnumUtils<Enum>::Count(); }
        template <typename Enum>
        static EnumText ToString(Enum value) { return Rendu::Impl::EnumUtils<Enum>::ToString(value); }
        template <typename Enum>
        static Enum FromIndex(size_t index) { return Rendu::Impl::EnumUtils<Enum>::FromIndex(index); }
