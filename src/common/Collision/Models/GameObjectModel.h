...
class RENDU_COMMON_API GameObjectModelOwnerBase
{
public:
...
class RENDU_COMMON_API GameObjectModel /*, public Intersectable*/
{
...
RENDU_COMMON_API void LoadGameObjectModelList(std::string const& dataPath);
