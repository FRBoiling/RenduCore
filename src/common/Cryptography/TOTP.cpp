...
constexpr std::size_t Rendu::Crypto::TOTP::RECOMMENDED_SECRET_LENGTH;
static constexpr uint32 TOTP_INTERVAL = 30;
static constexpr uint32 HMAC_RESULT_SIZE = 20;
/*static*/ uint32 Rendu::Crypto::TOTP::GenerateToken(Secret const& secret, time_t timestamp)
{
...
/*static*/ bool Rendu::Crypto::TOTP::ValidateToken(Secret const& secret, uint32 token)
{
