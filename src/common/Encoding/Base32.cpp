...
/*static*/ std::string Rendu::Encoding::Base32::Encode(std::vector<uint8> const& data)
{
    return Rendu::Impl::GenericBaseEncoding<B32Impl>::Encode(data);
}

/*static*/ Optional<std::vector<uint8>> Rendu::Encoding::Base32::Decode(std::string const& data)
{
    return Rendu::Impl::GenericBaseEncoding<B32Impl>::Decode(data);
}
