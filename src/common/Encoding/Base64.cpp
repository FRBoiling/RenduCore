...
/*static*/ std::string Rendu::Encoding::Base64::Encode(std::vector<uint8> const& data)
{
    return Rendu::Impl::GenericBaseEncoding<B64Impl>::Encode(data);
}

/*static*/ Optional<std::vector<uint8>> Rendu::Encoding::Base64::Decode(std::string const& data)
{
    return Rendu::Impl::GenericBaseEncoding<B64Impl>::Decode(data);
}
