...
uint8 Rendu::Helpers::Entity::GetPlayerSpecialization(Player const* who)
{
    if (!who)
        return 0;
...
bool Rendu::Helpers::Entity::IsPlayerHealer(Player const* who)
{
    if (!who)
        return false;
    ...
    switch (who->GetClass())
    {
        ...
        default:
            return false;
        case CLASS_PALADIN:
            return (Rendu::Helpers::Entity::GetPlayerSpecialization(who) == SPEC_PALADIN_HOLY);
        case CLASS_PRIEST:
            return (Rendu::Helpers::Entity::GetPlayerSpecialization(who) != SPEC_PRIEST_SHADOW);
        case CLASS_SHAMAN:
            return (Rendu::Helpers::Entity::GetPlayerSpecialization(who) == SPEC_SHAMAN_RESTORATION);
        case CLASS_DRUID:
            return (Rendu::Helpers::Entity::GetPlayerSpecialization(who) == SPEC_DRUID_RESTORATION);
    }
}

bool Rendu::Helpers::Entity::IsPlayerRangedAttacker(Player const* who)
{
    if (!who)
        return false;
    ...
    switch (who->GetClass())
    {
        ...
        case CLASS_PRIEST:
            return (Rendu::Helpers::Entity::GetPlayerSpecialization(who) == SPEC_PRIEST_SHADOW);
        case CLASS_SHAMAN:
            return (Rendu::Helpers::Entity::GetPlayerSpecialization(who) == SPEC_SHAMAN_ELEMENTAL);
        case CLASS_DRUID:
            return (Rendu::Helpers::Entity::GetPlayerSpecialization(who) == SPEC_DRUID_BALANCE);
    }
}
