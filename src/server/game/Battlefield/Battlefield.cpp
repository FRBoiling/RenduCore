...
bool BfCapturePoint::Update(uint32 diff)
{
    ...
    if (GameObject* capturePoint = m_Bf->GetGameObject(m_capturePointGUID))
    {
        ...
        Rendu::AnyPlayerInObjectRangeCheck checker(capturePoint, radius);
        Rendu::PlayerListSearcher<Rendu::AnyPlayerInObjectRangeCheck> searcher(capturePoint, players, checker);
