...
void Rendu::BroadcastTextBuilder::operator()(WorldPacket& data, LocaleConstant locale) const
{
...
size_t Rendu::BroadcastTextBuilder::operator()(WorldPacket* data, LocaleConstant locale) const
{
    BroadcastText const* bct = sObjectMgr->GetBroadcastText(_textId);
...
void Rendu::CustomChatTextBuilder::operator()(WorldPacket& data, LocaleConstant locale) const
{
    ChatHandler::BuildChatPacket(data, _msgType, _language, _source, _target, _text, 0, "", locale);
}

void Rendu::TrinityStringChatBuilder::operator()(WorldPacket& data, LocaleConstant locale) const
{
