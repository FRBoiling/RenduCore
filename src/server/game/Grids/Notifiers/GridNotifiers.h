...
namespace Rendu
{
    struct RENDU_GAME_API VisibleNotifier
    {
        Player &i_player;
        UpdateData i_data;
    ...
    struct RENDU_GAME_API PlayerRelocationNotifier : public VisibleNotifier
    {
    ...
    struct RENDU_GAME_API CreatureRelocationNotifier
    {
        Creature &i_creature;
    ...
    struct RENDU_GAME_API DelayedUnitRelocation
    {
        Map &i_map;
        Cell &cell;
        CellCoord &p;
    ...
    struct RENDU_GAME_API AIRelocationNotifier
    {
        Unit &i_unit;
        bool isCreature;
    ...
    struct RENDU_GAME_API MessageDistDeliverer
    {
    ...
    struct RENDU_GAME_API MessageDistDelivererToHostile
    {
        Unit* i_source;
        WorldPacket const* i_message;
        uint32 i_phaseMask;
    ...
    class RENDU_GAME_API AnyDeadUnitObjectInRangeCheck
    {
        public:
    ...
    class RENDU_GAME_API AnyDeadUnitSpellTargetInRangeCheck : public AnyDeadUnitObjectInRangeCheck, public WorldObjectSpellTargetCheck
    {
        public:
