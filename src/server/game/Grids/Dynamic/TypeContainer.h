...
{
    public:
        template<class SPECIFIC_TYPE> size_t Count() const { return Rendu::Count(i_elements, (SPECIFIC_TYPE*)nullptr); }

        /// inserts a specific object into the container
        template<class SPECIFIC_TYPE>
        bool insert(SPECIFIC_TYPE *obj)
        {
            SPECIFIC_TYPE* t = Rendu::Insert(i_elements, obj);
            return (t != nullptr);
        }
        ...
        //{
        //    SPECIFIC_TYPE* t = Rendu::Remove(i_elements, obj);
        //    return (t != nullptr);
        //}
...
public:
    ...
    {
        return Rendu::Insert(_elements, handle, obj);
    }

    template<class SPECIFIC_TYPE>
    bool Remove(KEY_TYPE const& handle)
    {
        return Rendu::Remove(_elements, handle, (SPECIFIC_TYPE*)nullptr);
    }

    template<class SPECIFIC_TYPE>
    SPECIFIC_TYPE* Find(KEY_TYPE const& handle)
    {
        return Rendu::Find(_elements, handle, (SPECIFIC_TYPE*)nullptr);
    }
    ...
    {
        std::size_t size = 0;
        Rendu::Size(_elements, &size, (SPECIFIC_TYPE*)nullptr);
        return size;
    }
