...
class RENDU_GAME_API AggressorAI : public CreatureAI
{
    public:
...
class RENDU_GAME_API CombatAI : public CreatureAI
{
    public:
...
class RENDU_GAME_API CasterAI : public CombatAI
{
    public:
...
struct RENDU_GAME_API ArcherAI : public CreatureAI
{
    public:
...
struct RENDU_GAME_API TurretAI : public CreatureAI
{
    public:
...
struct RENDU_GAME_API VehicleAI : public CreatureAI
{
    public:
