...
struct RENDU_GAME_API DefaultTargetSelector
{
    public:
...
struct RENDU_GAME_API SpellTargetSelector
{
    public:
...
struct RENDU_GAME_API NonTankTargetSelector
{
    public:
...
struct RENDU_GAME_API PowerUsersSelector
{
    public:
...
struct RENDU_GAME_API FarthestTargetSelector
{
    public:
    ...
    public:
        ...
        Unit* SelectTarget(SelectTargetMethod targetType, uint32 offset, PREDICATE const& predicate)
        {
            ...
            switch (targetType)
            {
                ...
                case SelectTargetMethod::Random:
                    return Rendu::Containers::SelectRandomContainerElement(targetList);
                default:
                    return nullptr;
            }
        }
        ...
        void SelectTargetList(std::list<Unit*>& targetList, uint32 num, SelectTargetMethod targetType, uint32 offset, PREDICATE const& predicate)
        {
            ...
            if (targetType == SelectTargetMethod::Random)
                Rendu::Containers::RandomResize(targetList, num);
            else
