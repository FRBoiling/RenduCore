...
void TotemAI::UpdateAI(uint32 /*diff*/)
{
    ...
    {
        victim = nullptr;
        Rendu::NearestAttackableUnitInObjectRangeCheck u_check(me, me->GetCharmerOrOwnerOrSelf(), max_range);
        Rendu::UnitLastSearcher<Rendu::NearestAttackableUnitInObjectRangeCheck> checker(me, victim, u_check);
