...
\***************************************************************/
template <>
RENDU_API_EXPORT EnumText EnumUtils<UnitFlags>::ToString(UnitFlags value)
{
    switch (value)
    {
...
template <>
RENDU_API_EXPORT size_t EnumUtils<UnitFlags>::Count() { return 32; }

template <>
RENDU_API_EXPORT UnitFlags EnumUtils<UnitFlags>::FromIndex(size_t index)
{
    switch (index)
    {
...
\**************************************************************/
template <>
RENDU_API_EXPORT EnumText EnumUtils<NPCFlags>::ToString(NPCFlags value)
{
    switch (value)
    {
...
template <>
RENDU_API_EXPORT size_t EnumUtils<NPCFlags>::Count() { return 27; }

template <>
RENDU_API_EXPORT NPCFlags EnumUtils<NPCFlags>::FromIndex(size_t index)
{
    switch (index)
    {
