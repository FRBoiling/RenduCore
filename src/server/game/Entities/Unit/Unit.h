...
class RENDU_GAME_API DispelableAura
{
    public:
...
RENDU_GAME_API extern float baseMoveSpeed[MAX_MOVE_TYPE];
RENDU_GAME_API extern float playerBaseMoveSpeed[MAX_MOVE_TYPE];
...
class RENDU_GAME_API DamageInfo
{
    private:
...
class RENDU_GAME_API ProcEventInfo
{
    public:
...
struct RENDU_GAME_API SpellNonMeleeDamage
{
...
struct RENDU_GAME_API CharmInfo
{
    public:
...
class RENDU_GAME_API Unit : public WorldObject
{
    public:
