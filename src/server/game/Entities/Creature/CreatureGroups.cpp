...
void FormationMgr::AddCreatureToGroup(ObjectGuid::LowType leaderSpawnId, Creature* creature)
{
    ...
    if (itr != map->CreatureGroupHolder.end())
    {
        ...
        auto bounds = Rendu::Containers::MapEqualRange(map->GetCreatureBySpawnIdStore(), creature->GetSpawnId());
...
{
    return Rendu::Containers::MapGetValuePtr(_creatureGroupMap, spawnId);
}
