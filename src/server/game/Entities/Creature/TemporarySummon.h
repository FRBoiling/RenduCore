...
class RENDU_GAME_API TempSummon : public Creature
{
    public:
...
class RENDU_GAME_API Minion : public TempSummon
{
    public:
...
class RENDU_GAME_API Guardian : public Minion
{
    public:
...
class RENDU_GAME_API Puppet : public Minion
{
    public:
...
class RENDU_GAME_API ForcedUnsummonDelayEvent : public BasicEvent
{
public:
