...
void WorldObject::GetRandomPoint(Position const& pos, float distance, float& rand_x, float& rand_y, float& rand_z) const
{
    ...
    Rendu::NormalizeMapCoord(rand_x);
    Rendu::NormalizeMapCoord(rand_y);
...
{
    Rendu::MessageDistDeliverer notifier(this, data, dist);
    Cell::VisitWorldObjects(this, notifier, dist);
}

void WorldObject::SendMessageToSet(WorldPacket const* data, Player const* skipped_rcvr) const
{
    Rendu::MessageDistDeliverer notifier(this, data, GetVisibilityRange(), false, skipped_rcvr);
...
TempSummon* Map::SummonCreature(uint32 entry, Position const& pos, SummonPropertiesEntry const* properties /*= nullptr*/, uint32 duration /*= 0*/, WorldObject* summoner /*= nullptr*/, uint32 spellId /*= 0*/, uint32 vehId /*= 0*/)
{
    ...
    Rendu::AIRelocationNotifier notifier(*summon);
...
Creature* WorldObject::FindNearestCreature(uint32 entry, float range, bool alive) const
{
    ...
    Rendu::NearestCreatureEntryWithLiveStateInObjectRangeCheck checker(*this, entry, alive, range);
    Rendu::CreatureLastSearcher<Rendu::NearestCreatureEntryWithLiveStateInObjectRangeCheck> searcher(this, creature, checker);
...
GameObject* WorldObject::FindNearestGameObject(uint32 entry, float range) const
{
    ...
    Rendu::NearestGameObjectEntryInObjectRangeCheck checker(*this, entry, range);
    Rendu::GameObjectLastSearcher<Rendu::NearestGameObjectEntryInObjectRangeCheck> searcher(this, go, checker);
...
{
    GameObject* go = nullptr;
    Rendu::NearestUnspawnedGameObjectEntryInObjectRangeCheck checker(*this, entry, range);
    Rendu::GameObjectLastSearcher<Rendu::NearestUnspawnedGameObjectEntryInObjectRangeCheck> searcher(this, go, checker);
    Cell::VisitGridObjects(this, searcher, range);
    return go;
}
...
{
    GameObject* go = nullptr;
    Rendu::NearestGameObjectTypeInObjectRangeCheck checker(*this, type, range);
    Rendu::GameObjectLastSearcher<Rendu::NearestGameObjectTypeInObjectRangeCheck> searcher(this, go, checker);
    Cell::VisitGridObjects(this, searcher, range);
    return go;
}
...
Player* WorldObject::SelectNearestPlayer(float distance) const
{
    ...
    Rendu::NearestPlayerInObjectRangeCheck checker(this, distance);
    Rendu::PlayerLastSearcher<Rendu::NearestPlayerInObjectRangeCheck> searcher(this, target, checker);
...
{
    Rendu::AllGameObjectsWithEntryInRange check(this, entry, maxSearchRange);
    Rendu::GameObjectListSearcher<Rendu::AllGameObjectsWithEntryInRange> searcher(this, gameObjectContainer, check);
...
{
    Rendu::AllCreaturesOfEntryInRange check(this, entry, maxSearchRange);
    Rendu::CreatureListSearcher<Rendu::AllCreaturesOfEntryInRange> searcher(this, creatureContainer, check);
    Cell::VisitGridObjects(this, searcher, maxSearchRange);
}
...
{
    Rendu::AnyPlayerInObjectRangeCheck checker(this, maxSearchRange);
    Rendu::PlayerListSearcher<Rendu::AnyPlayerInObjectRangeCheck> searcher(this, playerContainer, checker);
...
void WorldObject::GetNearPoint2D(WorldObject const* searcher, float& x, float& y, float distance2d, float absAngle) const
{
    ...
    Rendu::NormalizeMapCoord(x);
    Rendu::NormalizeMapCoord(y);
}
...
void WorldObject::MovePosition(Position &pos, float dist, float angle)
{
    ...
    if (!Rendu::IsValidMapCoord(destx, desty, pos.m_positionZ))
    {
    ...
    Rendu::NormalizeMapCoord(pos.m_positionX);
    Rendu::NormalizeMapCoord(pos.m_positionY);
...
void WorldObject::MovePositionToFirstCollision(Position &pos, float dist, float angle)
{
    ...
    // Prevent invalid coordinates here, position is unchanged
    if (!Rendu::IsValidMapCoord(destx, desty))
    {
...
void WorldObject::DestroyForNearbyPlayers()
{
    ...
    Rendu::AnyPlayerInObjectRangeCheck check(this, GetVisibilityRange(), false);
    Rendu::PlayerListSearcher<Rendu::AnyPlayerInObjectRangeCheck> searcher(this, targets, check);
...
void WorldObject::UpdateObjectVisibility(bool /*forced*/)
{
    ...
    Rendu::VisibleChangesNotifier notifier(*this);
    Cell::VisitWorldObjects(this, notifier, GetVisibilityRange());
}
...
template RENDU_GAME_API void WorldObject::GetGameObjectListWithEntryInGrid(std::list<GameObject*>&, uint32, float) const;
template RENDU_GAME_API void WorldObject::GetGameObjectListWithEntryInGrid(std::deque<GameObject*>&, uint32, float) const;
template RENDU_GAME_API void WorldObject::GetGameObjectListWithEntryInGrid(std::vector<GameObject*>&, uint32, float) const;

template RENDU_GAME_API void WorldObject::GetCreatureListWithEntryInGrid(std::list<Creature*>&, uint32, float) const;
template RENDU_GAME_API void WorldObject::GetCreatureListWithEntryInGrid(std::deque<Creature*>&, uint32, float) const;
template RENDU_GAME_API void WorldObject::GetCreatureListWithEntryInGrid(std::vector<Creature*>&, uint32, float) const;

template RENDU_GAME_API void WorldObject::GetPlayerListInGrid(std::list<Player*>&, float) const;
template RENDU_GAME_API void WorldObject::GetPlayerListInGrid(std::deque<Player*>&, float) const;
template RENDU_GAME_API void WorldObject::GetPlayerListInGrid(std::vector<Player*>&, float) const;
