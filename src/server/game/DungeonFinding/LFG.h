...
RENDU_GAME_API std::string ConcatenateDungeons(LfgDungeonSet const& dungeons);
RENDU_GAME_API std::string GetRolesString(uint8 roles);
RENDU_GAME_API std::string GetStateString(LfgState state);
