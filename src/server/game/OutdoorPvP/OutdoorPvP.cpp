...
bool OPvPCapturePoint::Update(uint32 diff)
{
    ...
    Rendu::AnyPlayerInObjectRangeCheck checker(m_capturePoint, radius);
    Rendu::PlayerListSearcher<Rendu::AnyPlayerInObjectRangeCheck> searcher(m_capturePoint, players, checker);
...
void OutdoorPvP::SendDefenseMessage(uint32 zoneId, uint32 id)
{
    ...
    Rendu::LocalizedPacketDo<DefenseMessageBuilder> localizer(builder);
