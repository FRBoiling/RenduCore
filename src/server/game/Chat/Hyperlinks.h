...
#undef make_base_tag
    ...
    struct RENDU_GAME_API achievement
    {
...
HyperlinkInfo RENDU_GAME_API ParseHyperlink(char const* pos);
bool RENDU_GAME_API CheckAllLinks(std::string const&);
