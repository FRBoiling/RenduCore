...
void WorldSession::HandleTextEmoteOpcode(WorldPacket& recvData)
{
    ...
    CellCoord p = Rendu::ComputeCellCoord(GetPlayer()->GetPositionX(), GetPlayer()->GetPositionY());

    Cell cell(p);
    cell.SetNoCreate();

    Rendu::EmoteChatBuilder emote_builder(*GetPlayer(), text_emote, emoteNum, unit);
    Rendu::LocalizedPacketDo<Rendu::EmoteChatBuilder > emote_do(emote_builder);
    Rendu::PlayerDistWorker<Rendu::LocalizedPacketDo<Rendu::EmoteChatBuilder > > emote_worker(GetPlayer(), sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_TEXTEMOTE), emote_do);
    TypeContainerVisitor<Rendu::PlayerDistWorker<Rendu::LocalizedPacketDo<Rendu::EmoteChatBuilder> >, WorldTypeMapContainer> message(emote_worker);
