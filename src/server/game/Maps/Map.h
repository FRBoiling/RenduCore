...
namespace Rendu { struct ObjectUpdater; }
...
class RENDU_GAME_API Map : public GridRefManager<NGridType>
{
    ...
    public:
        ...
        void VisitNearbyCellsOf(WorldObject* obj, TypeContainerVisitor<Rendu::ObjectUpdater, GridTypeMapContainer> &gridVisitor, TypeContainerVisitor<Rendu::ObjectUpdater, WorldTypeMapContainer> &worldVisitor);
        ...
        bool IsGridLoaded(float x, float y) const { return IsGridLoaded(Rendu::ComputeGridCoord(x, y)); }
...
class RENDU_GAME_API InstanceMap : public Map
{
    public:
...
class RENDU_GAME_API BattlegroundMap : public Map
{
    public:
