...
struct RENDU_GAME_API SpellArea
{
    uint32 spellId;
...
class RENDU_GAME_API SpellMgr
{
    ...
    public:
        ...
        Rendu::IteratorPair<SpellRequiredMap::const_iterator> GetSpellsRequiredForSpellBounds(uint32 spell_id) const;
