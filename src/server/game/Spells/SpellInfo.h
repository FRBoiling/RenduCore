...
class RENDU_GAME_API SpellImplicitTargetInfo
{
private:
    Targets _target;
public:
...
class RENDU_GAME_API SpellEffectInfo
{
...
struct RENDU_GAME_API SpellDiminishInfo
{
...
struct RENDU_GAME_API ImmunityInfo
{
...
class RENDU_GAME_API SpellInfo
{
