...
class RENDU_GAME_API AuraApplication
{
    friend class Unit;
...
class RENDU_GAME_API UnitAura : public Aura
{
...
class RENDU_GAME_API DynObjAura : public Aura
{
    friend Aura* Aura::Create(AuraCreateInfo& createInfo);
    protected:
...
class RENDU_GAME_API ChargeDropEvent : public BasicEvent
{
    friend class Aura;
    protected:
