...
struct RENDU_GAME_API SpellDestination
{
    SpellDestination();
...
class RENDU_GAME_API SpellCastTargets
{
    public:
        SpellCastTargets();
        ~SpellCastTargets();
...
namespace Rendu
{
    struct RENDU_GAME_API WorldObjectSpellTargetCheck
    {
        protected:
            WorldObject* _caster;
    ...
    struct RENDU_GAME_API WorldObjectSpellNearbyTargetCheck : public WorldObjectSpellTargetCheck
    {
        float _range;
    ...
    struct RENDU_GAME_API WorldObjectSpellAreaTargetCheck : public WorldObjectSpellTargetCheck
    {
        float _range;
        Position const* _position;
    ...
    struct RENDU_GAME_API WorldObjectSpellConeTargetCheck : public WorldObjectSpellAreaTargetCheck
    {
        float _coneAngle;
    ...
    struct RENDU_GAME_API WorldObjectSpellTrajTargetCheck : public WorldObjectSpellTargetCheck
    {
        float _range;
        Position const* _position;
