...
Rendu::IteratorPair<SpellRequiredMap::const_iterator> SpellMgr::GetSpellsRequiredForSpellBounds(uint32 spell_id) const
{
    return Rendu::Containers::MapEqualRange(mSpellReq, spell_id);
}
...
{
    return Rendu::Containers::MapGetValuePtr(mSpellLinkedMap, spell_id);
}
