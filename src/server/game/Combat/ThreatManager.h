...
class RENDU_GAME_API ThreatManager
{
    public:
        ...
        Rendu::IteratorPair<ThreatListIterator> GetUnsortedThreatList() const { return { _myThreatListEntries.begin(), _myThreatListEntries.end() }; }
        ...
        Rendu::IteratorPair<threat_list_heap::ordered_iterator> GetSortedThreatList() const { return { _sortedThreatList.ordered_begin(), _sortedThreatList.ordered_end() }; }
...
// Please check Game/Combat/ThreatManager.h for documentation on how this class works!
class RENDU_GAME_API ThreatReference
{
    public:
