...
class Battleground;
class RENDU_GAME_API BattlegroundQueue
{
    public:
        BattlegroundQueue();
        ~BattlegroundQueue();
...
*/
class RENDU_GAME_API BGQueueInviteEvent : public BasicEvent
{
    public:
...
*/
class RENDU_GAME_API BGQueueRemoveEvent : public BasicEvent
{
    public:
