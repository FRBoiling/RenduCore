...
namespace WorldPackets
{
    namespace Misc
    {
        ...
        class RENDU_GAME_API Weather final : public ServerPacket
        {
        public:
            Weather();
        ...
        class RENDU_GAME_API PlayMusic final : public ServerPacket
        {
        public:
        ...
        class RENDU_GAME_API PlayObjectSound final : public ServerPacket
        {
        public:
        ...
        class RENDU_GAME_API PlaySound final : public ServerPacket
        {
        public:
