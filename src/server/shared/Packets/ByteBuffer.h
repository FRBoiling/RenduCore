...
class RENDU_SHARED_API ByteBufferException : public std::exception
{
public:
...
class RENDU_SHARED_API ByteBufferPositionException : public ByteBufferException
{
public:
...
class RENDU_SHARED_API ByteBufferSourceException : public ByteBufferException
{
public:
...
class RENDU_SHARED_API ByteBufferInvalidValueException : public ByteBufferException
{
public:
...
class RENDU_SHARED_API ByteBuffer
{
    public:
