...
class RENDU_SHARED_API RealmList
{
public:
    ...
    void Initialize(Rendu::Asio::IoContext& ioContext, uint32 updateInterval);
    void Close();
...
private:
    ...
    std::unique_ptr<Rendu::Asio::DeadlineTimer> _updateTimer;
