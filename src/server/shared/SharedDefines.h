...
#ifndef RENDU_SHAREDDEFINES_H
#define RENDU_SHAREDDEFINES_H
...
#define RACEMASK_ALL_PLAYABLE                                                  \
  ((1 << (RACE_HUMAN - 1)) | (1 << (RACE_ORC - 1)) | (1 << (RACE_DWARF - 1)) | \
   (1 << (RACE_NIGHTELF - 1)) | (1 << (RACE_UNDEAD_PLAYER - 1)) |              \
   (1 << (RACE_TAUREN - 1)) | (1 << (RACE_GNOME - 1)) |                        \
...
inline SpellSchools GetFirstSchoolInMask(SpellSchoolMask mask) {
  for (SpellSchools school : EnumUtils::Iterate<SpellSchools>())
    if (mask & GetMaskForSchool(school)) return school;
...
enum SpellAttr0 : uint32 {
  ...
  SPELL_ATTR0_PASSIVE = 0x00000040,  // TITLE Passive spell DESCRIPTION Spell is
                                     // automatically cast on self by core
  SPELL_ATTR0_HIDDEN_CLIENTSIDE =
      0x00000080,  // TITLE Hidden in UI (client only) DESCRIPTION Not visible
                   // in spellbook or aura bar
  SPELL_ATTR0_HIDE_IN_COMBAT_LOG =
      0x00000100,  // TITLE Hidden in combat log (client only) DESCRIPTION Spell
                   // will not appear in combat logs
  ...
  SPELL_ATTR0_DISABLED_WHILE_ACTIVE =
      0x02000000,  // TITLE Cooldown starts on expiry DESCRIPTION Spell is
                   // unusable while already active, and cooldown does not begin
                   // until the effects have worn off
  SPELL_ATTR0_NEGATIVE_1 =
      0x04000000,  // TITLE Is negative spell DESCRIPTION Forces the spell to be
                   // treated as a negative spell
...
enum SpellAttr1 : uint32 {
  ...
  SPELL_ATTR1_MELEE_COMBAT_START =
      0x00000200,  // TITLE Starts auto-attack (client only) DESCRIPTION Caster
                   // will begin auto-attacking the target on cast
  SPELL_ATTR1_NO_THREAT =
      0x00000400,  // TITLE Does not generate threat DESCRIPTION Also does not
                   // cause target to engage
  SPELL_ATTR1_UNK11 =
      0x00000800,  // TITLE Unknown attribute 11@Attr1 DESCRIPTION Aura?
  ...
  SPELL_ATTR1_UNAFFECTED_BY_SCHOOL_IMMUNE =
      0x00010000,  // TITLE Unaffected by school immunities DESCRIPTION Will not
                   // pierce Divine Shield, Ice Block and other full
                   // invulnerabilities
  SPELL_ATTR1_UNAUTOCASTABLE_BY_PET =
      0x00020000,  // TITLE Cannot be autocast by pet
  SPELL_ATTR1_UNK18 =
      0x00040000,  // TITLE Unknown attribute 18@Attr1 DESCRIPTION Stun,
                   // Polymorph, Daze, Hex - CC?
...
enum SpellAttr2 : uint32 {
  ...
  SPELL_ATTR2_UNK10 = 0x00000400,          // TITLE Unknown attribute 10@Attr2
  ...
  SPELL_ATTR2_NOT_NEED_SHAPESHIFT =
      0x00080000,  // TITLE Also allow outside shapeshift DESCRIPTION Even if
                   // Stances are nonzero, allow spell to be cast outside of
                   // shapeshift (though not in a different shapeshift)
  SPELL_ATTR2_UNK20 = 0x00100000,  // TITLE Unknown attribute 20@Attr2
  SPELL_ATTR2_DAMAGE_REDUCED_SHIELD =
      0x00200000,  // TITLE Damage reduction ability DESCRIPTION Causes BG flags
                   // to be dropped if combined with
  ...
  SPELL_ATTR2_UNAFFECTED_BY_AURA_SCHOOL_IMMUNE =
      0x04000000,  // TITLE Pierce aura application immunities DESCRIPTION Allow
                   // aura to be applied despite target being immune to new aura
                   // applications
...
enum SpellAttr3 : uint32 {
  ...
  SPELL_ATTR3_IGNORE_PROC_SUBCLASS_MASK =
      0x00000002,  //  1 Ignores subclass mask check when checking proc
  ...
  SPELL_ATTR3_IGNORE_RESURRECTION_TIMER =
      0x00000010,                 // TITLE Ignore resurrection timer
  ...
  SPELL_ATTR3_ONLY_TARGET_PLAYERS =
      0x00000100,  // TITLE Can only target players
...
enum SpellAttr4 : uint32 {
  ...
  SPELL_ATTR4_NOT_USABLE_IN_ARENA =
      0x00010000,  // TITLE Not usable in arena DESCRIPTION Makes spell unusable
                   // despite CD <= 10min
  ...
  SPELL_ATTR4_UNK24 = 0x01000000,           // TITLE Unknown attribute 24@Attr4
                                            // DESCRIPTION Shoot-type spell?
...
enum SpellAttr5 : uint32 {
  SPELL_ATTR5_CAN_CHANNEL_WHEN_MOVING =
      0x00000001,  // TITLE Can be channeled while moving
  ...
  SPELL_ATTR5_UNK12 = 0x00001000,  // TITLE Unknown attribute 12@Attr5
                                   // DESCRIPTION Cleave related?
...
enum SpellAttr6 : uint32 {
  ...
  SPELL_ATTR6_UNK17 = 0x00020000,  // TITLE Unknown attribute 17@Attr6
                                   // DESCRIPTION Mount related?
  ...
  SPELL_ATTR6_ONLY_VISIBLE_TO_CASTER =
      0x00100000,  // TITLE Only visible to caster (client only)
  ...
  SPELL_ATTR6_UNK26 = 0x04000000,  // TITLE Unknown attribute 26@Attr6
                                   // DESCRIPTION Player castable buff?
  SPELL_ATTR6_LIMIT_PCT_HEALING_MODS =
      0x08000000,  // TITLE Limit applicable %healing modifiers DESCRIPTION This
                   // prevents certain healing modifiers from applying - see
...
enum SpellAttr7 : uint32 {
  ...
  SPELL_ATTR7_UNK4 = 0x00000010,  // TITLE Unknown attribute 4@Attr7 DESCRIPTION
                                  // Soulstone related?
  ...
  SPELL_ATTR7_UNK20 = 0x00100000,  // TITLE Unknown attribute 20@Attr7
                                   // DESCRIPTION Invulnerability related?
...
enum SpellCustomErrors {
  ...
  SPELL_CUSTOM_ERROR_WYRMREST_VANQUISHER =
      20,  // You may only call for the aid of a Wyrmrest Vanquisher in Wyrmrest
           // Temple, The Dragon Wastes, Galakrond's Rest or The Wicked Coil.
  ...
  SPELL_CUSTOM_ERROR_MUST_BE_IN_RESURRECTION_CHAMBER =
      25,  // Requires the magmawyrm resurrection chamber in the back of the Maw
           // of Neltharion.
  ...
  SPELL_CUSTOM_ERROR_MUST_HAVE_USED_DALARAN_CRYSTAL =
      37,  // This teleport crystal cannot be used until the teleport crystal in
           // Dalaran has been used at least once.
  SPELL_CUSTOM_ERROR_YOU_ALREADY_HOLD_SOMETHING =
      38,  // You are already holding something in your hand. You must throw the
           // creature in your hand before picking up another.
  SPELL_CUSTOM_ERROR_YOU_DONT_HOLD_ANYTHING =
      39,  // You don't have anything to throw! Find a Vargul and use Gymer Grab
           // to pick one up!
...
// Spell aura states
enum AuraStateType {  // (C) used in caster aura state     (T) used in target
                      // aura state (c) used in caster aura state-not (t) used
                      // in target aura state-not
  AURA_STATE_NONE = 0,                   // C   |
  ...
  AURA_STATE_HUNTER_PARRY =
      7,  // C   |
          ...
          // creature cheap shot / focused bursts spells AURA_STATE_UNKNOWN8 = 8,
          // //    t| test spells AURA_STATE_UNKNOWN9                   = 9, // |
...
enum GameObjectFlags {
  ...
  GO_FLAG_INTERACT_COND =
      0x00000004,  // cannot interact (condition to interact - requires
                   // GO_DYNFLAG_LO_ACTIVATE to enable interaction clientside)
  ...
  GO_FLAG_AI_OBSTACLE =
      0x00000040,  // makes the client register the object in something called
                   // AIObstacleMgr, unknown what it does
...
enum GOState : uint8 {
  ...
  GO_STATE_DESTROYED = 2  // show the object in-game as already used and not yet
                          // reset (e.g. door opened by a cannon blast)
};
...
enum CreatureFamily {
  ...
  CREATURE_FAMILY_HORSE_CUSTOM =
      10,  // Does not exist in DBC but used for horse like beasts in DB
...
enum CreatureTypeFlags {
  ...
  CREATURE_TYPE_FLAG_GHOST_VISIBLE =
      0x00000002,  // Creature are also visible for not alive player. Allow
                   // gossip interaction if npcflag allow?
  CREATURE_TYPE_FLAG_BOSS_MOB =
      0x00000004,  // Changes creature's visible level to "??" in the creature's
                   // portrait - Immune Knockback.
...
// CreatureFamilyEntry.PetFoodMask
enum PetDiet {
  PET_DIET_MEAT = 1,
  PET_DIET_FISH = 2,
  PET_DIET_CHEESE = 3,
...
enum SummonCategory {
  ...
  SUMMON_CATEGORY_UNK = 5  // as of patch 3.3.5a only Bone Spike in Icecrown
                           // Citadel uses this category
};
...
enum GroupJoinBattlegroundResult {
  ...
  ERR_BATTLEDGROUND_QUEUED_FOR_RATED =
      -6,  // You cannot queue for another battle while queued for a rated arena
           // match
  ...
  ERR_BATTLEGROUND_JOIN_RANGE_INDEX =
      -10,  // Cannot join the queue unless all members of your party are in the
            // same battleground level range.
  ERR_BATTLEGROUND_JOIN_TIMED_OUT =
      -11,  // %s was unavailable to join the queue. (uint64 guid exist in
            // client cache)
  ERR_BATTLEGROUND_JOIN_FAILED = -12,  // Join as a group failed (uint64 guid
                                       // doesn't exist in client cache)
...
enum WorldState : uint32 {
  ...
  WS_DAILY_CALENDAR_DELETION_OLD_EVENTS_TIME =
      20009,  // Next daily calendar deletions of old events time
};
