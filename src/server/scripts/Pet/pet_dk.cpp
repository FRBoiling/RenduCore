    ...
    public:
        ...
        struct npc_pet_dk_ebon_gargoyleAI : CasterAI
        {
            ...
            void InitializeAI() override
            {
                ...
                Rendu::AnyUnfriendlyUnitInObjectRangeCheck u_check(me, me, 30.0f);
                Rendu::UnitListSearcher<Rendu::AnyUnfriendlyUnitInObjectRangeCheck> searcher(me, targets, u_check);
