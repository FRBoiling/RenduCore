                ...
                switch (event)
                {
                    ...
                    case RP2_EVENT_REACT5:
                    {
                        ...
                        if (!nearbyVictims.empty())
                        {
                            ...
                            Creature* victim = Rendu::Containers::SelectRandomContainerElement(nearbyVictims);
                            if (victim->IsAlive())
                                victim->HandleEmoteCommand(Rendu::Containers::SelectRandomContainerElement(emotes));
                        }
                        break;
                    }
