...
void hyjalAI::HideNearPos(float x, float y)
{
    ...
    Rendu::AllFriendlyCreaturesInGrid creature_check(me);
    Rendu::CreatureListSearcher<Rendu::AllFriendlyCreaturesInGrid> creature_searcher(me, creatures, creature_check);
...
void hyjalAI::RespawnNearPos(float x, float y)
{
    ...
    Rendu::WorldObjectWorker<Rendu::RespawnDo> worker(me, u_do);
