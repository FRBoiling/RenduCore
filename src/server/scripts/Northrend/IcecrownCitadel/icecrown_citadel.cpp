...
struct npc_icc_orb_controller : public ScriptedAI
{
    ...
    void Reset() override
    {
        _scheduler.Schedule(1s, [this](TaskContext /*initialize*/)
        {
            ...
            Rendu::CreatureListSearcher<ICCOrbControllerMinionSearch> searcher(me, creatures, check);
    ...
    void ScheduleVisualChannel(bool evading)
    {
        ...
        {
            ObjectGuid guid = Rendu::Containers::SelectRandomContainerElement(_minionGuids);
    ...
    void SetGUID(ObjectGuid const& guid, int32 id) override
    {
        ...
        if (Unit* minion = ObjectAccessor::GetUnit(*me, Rendu::Containers::SelectRandomContainerElement(_minionGuids)))
    ...
    void Reset() override
    {
        ...
        .Schedule(1s, 10s, [this](TaskContext emote)
        {
            ...
            if (roll_chance_i(20))
            {
                ...
                if (!creatures.empty())
                {
                    Creature* friendly = Rendu::Containers::SelectRandomContainerElement(creatures);
                    DoCast(friendly, SPELL_POLYMORPH_ALLY);
                }
            }
            Scheduler.Schedule(1s, [this](TaskContext /*emote*/)
            {
                me->HandleEmoteCommand(Rendu::Containers::SelectRandomContainerElement(DarkFallensEmotes));
            });
...
class spell_darkfallen_blood_mirror : public SpellScript
{
    ...
    void FilterTargets(std::list<WorldObject*>& targets)
    {
        ...
        _targets = targets;
        Rendu::Containers::RandomResize(_targets, 2);
    }
    ...
    public:
        ...
        class spell_icc_sprit_alarm_SpellScript : public SpellScript
        {
            ...
            void HandleEvent(SpellEffIndex effIndex)
            {
                ...
                wards.sort(Rendu::ObjectDistanceOrderPred(GetGObjCaster()));
    ...
    public:
        ...
        bool OnTrigger(Player* player, AreaTriggerEntry const* /*areaTrigger*/) override
        {
            ...
            if (instance->GetData(DATA_COLDFLAME_JETS) == NOT_STARTED)
            {
                ...
                traps.sort(Rendu::ObjectDistanceOrderPred(player));
                bool instant = false;
