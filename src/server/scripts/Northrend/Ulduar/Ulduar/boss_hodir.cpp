    ...
    public:
        ...
        struct boss_hodirAI : public BossAI
        {
            ...
            void FlashFreeze()
            {
                ...
                Rendu::AnyUnfriendlyUnitInObjectRangeCheck checker(me, me, 100.0f);
                Rendu::UnitListSearcher<Rendu::AnyUnfriendlyUnitInObjectRangeCheck> searcher(me, TargetList, checker);
            ...
            void UpdateAI(uint32 diff) override
            {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        {
                            std::list<Unit*> TargetList;
                            Rendu::AnyFriendlyUnitInObjectRangeCheck checker(me, me, 30.0f);
                            Rendu::UnitListSearcher<Rendu::AnyFriendlyUnitInObjectRangeCheck> searcher(me, TargetList, checker);
