...
public:
    ...
    static bool HandleGPSCommand(ChatHandler* handler, char const* args)
    {
        ...
        CellCoord cellCoord = Rendu::ComputeCellCoord(object->GetPositionX(), object->GetPositionY());
        Cell cell(cellCoord);
        ...
        GridCoord gridCoord = Rendu::ComputeGridCoord(object->GetPositionX(), object->GetPositionY());
    ...
    **/
    ...
    static bool HandleRespawnCommand(ChatHandler* handler, char const* /*args*/)
    {
        ...
        Rendu::RespawnDo u_do;
        Rendu::WorldObjectWorker<Rendu::RespawnDo> worker(player, u_do);
        ...
        if (!data.empty())
        {
            uint32 const gridId = Rendu::ComputeGridCoord(player->GetPositionX(), player->GetPositionY()).GetId();
