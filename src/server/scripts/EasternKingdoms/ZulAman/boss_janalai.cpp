    ...
    public:
        ...
        struct boss_janalaiAI : public BossAI
        {
            ...
            bool HatchAllEggs(uint32 action) //1: reset, 2: isHatching all
            {
                ...
                Rendu::AllCreaturesOfEntryInRange check(me, NPC_EGG, 100);
            ...
            void Boom()
            {
                ...
                Rendu::AllCreaturesOfEntryInRange check(me, NPC_FIRE_BOMB, 100);
                Rendu::CreatureListSearcher<Rendu::AllCreaturesOfEntryInRange> searcher(me, templist, check);
                Cell::VisitGridObjects(me, searcher, me->GetGridActivationRange());
    ...
    public:
        ...
        struct npc_janalai_hatcherAI : public ScriptedAI
        {
            ...
            bool HatchEggs(uint32 num)
            {
                ...
                Rendu::AllCreaturesOfEntryInRange check(me, 23817, 50);
                Rendu::CreatureListSearcher<Rendu::AllCreaturesOfEntryInRange> searcher(me, templist, check);
                Cell::VisitGridObjects(me, searcher, me->GetGridActivationRange());
