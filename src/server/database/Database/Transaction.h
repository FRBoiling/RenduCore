...
class RENDU_DATABASE_API TransactionBase
{
    ...
    public:
        ...
        {
            Append(Rendu::StringFormat(std::forward<Format>(sql), std::forward<Args>(args)...).c_str());
        }
...
/*! Low level class*/
class RENDU_DATABASE_API TransactionTask : public SQLOperation
{
...
class RENDU_DATABASE_API TransactionWithResultTask : public TransactionTask
{
public:
...
class RENDU_DATABASE_API TransactionCallback
{
public:
